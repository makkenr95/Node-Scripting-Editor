...
void CalcInterpolatedRotation(aiQuaternion& Out, float AnimationTime, const aiNodeAnim* pNodeAnim)
{
	...
	const float DeltaTime = static_cast<float>(pNodeAnim->mRotationKeys[NextRotationIndex].mTime) - static_cast<float>(pNodeAnim->mRotationKeys[RotationIndex].mTime);
...
void CalcInterpolatedScaling(aiVector3D& Out, float AnimationTime, const aiNodeAnim* pNodeAnim)
{
	...
	float DeltaTime = static_cast<float>(pNodeAnim->mScalingKeys[NextScalingIndex].mTime) - static_cast<float>(pNodeAnim->mScalingKeys[ScalingIndex].mTime);
...
void CalcInterpolatedPosition(aiVector3D& Out, float AnimationTime, const aiNodeAnim* pNodeAnim)
{
	...
	float DeltaTime = static_cast<float>(pNodeAnim->mPositionKeys[NextPositionIndex].mTime) - static_cast<float>(pNodeAnim->mPositionKeys[PositionIndex].mTime);
