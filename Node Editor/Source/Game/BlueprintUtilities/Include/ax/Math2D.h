...
struct basic_point
{
    ...
    inline basic_point cwise_min(const basic_point& rhs) const { return basic_point(min(x, rhs.x), min(y, rhs.y)); }
    inline basic_point cwise_max(const basic_point& rhs) const { return basic_point(max(x, rhs.x), max(y, rhs.y)); }
